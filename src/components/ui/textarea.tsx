 ...
 *
 * Combines default utility classes for consistent appearance and behavior, while allowing additional classes via the `className` prop. All other textarea attributes are supported through props.
 *
